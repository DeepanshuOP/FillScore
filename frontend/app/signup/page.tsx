        ...
        <div className="w-full max-w-[420px] relative overflow-hidden rounded-[3px]"
          ...
          <div className="px-[1.5rem] py-[2rem] sm:px-[2rem]">
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              <button type="submit" disabled={loading || !email || !password || !confirmPassword}
                style={{
                  ...
                  background: (loading || !email || !password || !confirmPassword) ? 'rgba(167,139,113,0.1)' : 'rgba(167,139,113,0.15)',
                  color: (loading || !email || !password || !confirmPassword) ? 'rgba(167,139,113,0.5)' : '#d4c4b4',
            ...
            <p style={{ marginTop: '2rem', textAlign: 'center', fontFamily: 'var(--font-inter)', fontSize: '0.8rem', color: '#6a6560' }}>
              Already have an account? <a href="/login" style={{ color: '#a78b71', textDecoration: 'none' }}>Log in</a>
            </p>
          </div>
        </div>
      </div>
